/*
** Lua binding: tclass
** Generated automatically by tolua++-1.0.92 on 03/14/14 10:29:52.
*/
...
static int tolua_tclass_Test_A_new00(lua_State* tolua_S)
{
 ...
 {
  {
   Test::Tst_A* tolua_ret = (Test::Tst_A*)  Mtolua_new((Test::Tst_A)());
...
static int tolua_tclass_Test_A_AA_new00(lua_State* tolua_S)
{
 ...
 {
  {
   Test::Tst_A::Tst_AA* tolua_ret = (Test::Tst_A::Tst_AA*)  Mtolua_new((Test::Tst_A::Tst_AA)());
...
static int tolua_tclass_Test_A_BB_new00(lua_State* tolua_S)
{
 ...
 {
  {
   Test::Tst_A::Tst_BB* tolua_ret = (Test::Tst_A::Tst_BB*)  Mtolua_new((Test::Tst_A::Tst_BB)());
...
static int tolua_tclass_Test_E__add00(lua_State* tolua_S)
{
 ...
 if (
     !tolua_isusertype(tolua_S,1,"Test::Tst_E",0,&tolua_err) ||
     (tolua_isvaluenil(tolua_S,2,&tolua_err) || !tolua_isusertype(tolua_S,2,"const Test::Tst_E",0,&tolua_err)) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
...
static int tolua_set_Test__Tst_E_a(lua_State* tolua_S)
{
  ...
  tolua_Error tolua_err;
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'a'",NULL);
  if ((tolua_isvaluenil(tolua_S,2,&tolua_err) || !tolua_isusertype(tolua_S,2,"Test::Tst_A",0,&tolua_err)))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
...
static int tolua_tclass_Test_E_new00(lua_State* tolua_S)
{
...
#endif
 {
  ...
  {
   Test::Tst_E* tolua_ret = (Test::Tst_E*)  Mtolua_new((Test::Tst_E)(tolua_var_1));
    tolua_pushusertype(tolua_S,(void*)tolua_ret,"Test::Tst_E");
  }
 }
 return 1;
...
static int tolua_tclass_Test_B_new00(lua_State* tolua_S)
{
 ...
 {
  {
   Test::Tst_B* tolua_ret = (Test::Tst_B*)  Mtolua_new((Test::Tst_B)());
...
static int tolua_tclass_Test_luaC_new00(lua_State* tolua_S)
{
...
#endif
 {
  ...
  {
   Test::Tst_C* tolua_ret = (Test::Tst_C*)  Mtolua_new((Test::Tst_C)(n));
...
static int tolua_tclass_Test_Outside_new00(lua_State* tolua_S)
{
 ...
 {
  {
   Test::Tst_Outside* tolua_ret = (Test::Tst_Outside*)  Mtolua_new((Test::Tst_Outside)());
